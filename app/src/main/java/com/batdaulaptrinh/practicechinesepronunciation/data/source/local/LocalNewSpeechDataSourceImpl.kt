...
class LocalNewSpeechDataSourceImpl @Inject constructor(private val newSpeechDao: NewSpeechDao) :
    ...
    override suspend fun insertNewSpeech(newSpeech: NewSpeechEntity) = newSpeechDao.insertNewSpeech(newSpeech)

    override suspend fun insertNewSpeeches(newSpeeches: List<NewSpeechEntity>) = newSpeechDao.insertNewSpeeches(newSpeeches)

    override suspend fun updateNewSpeech(newSpeech: NewSpeechEntity) = newSpeechDao.updateNewSpeech(newSpeech)

    override suspend fun deleteNewSpeech(newSpeech: NewSpeechEntity)  = newSpeechDao.deleteNewSpeech(newSpeech)
